...
extern spfg_err_t spfg_rt_dp_create(spfg_runtime_t *runtime, spfg_dp_type_t dp_type, const char * name, spfg_dp_id_t *dp_id)
{
    if (!runtime) {
        return SPFG_ERROR_BAD_PARAM_NULL_POINTER;
    }
    ...
    return _spfg_rt_dp_create((spfg_rt_t *)runtime, dp_type, name, dp_id);
}


extern spfg_err_t spfg_rt_dp_remove(spfg_runtime_t *runtime, spfg_dp_id_t dp_id)
{
    if (!runtime) {
        return SPFG_ERROR_BAD_PARAM_NULL_POINTER;
    }

    return _spfg_rt_dp_remove((spfg_rt_t *)runtime, dp_id);
}


extern spfg_err_t spfg_rt_fn_create(spfg_runtime_t *runtime,
                                    spfg_fn_type_t type,
                                    spfg_phase_t phase,
                                    spfg_dp_id_t in_dp_ids[], uint8_t in_dp_ids_len,
                                    spfg_dp_id_t out_dp_ids[], uint8_t out_dp_ids_len,
                                    ...
                                    spfg_fn_id_t *fn_id)
{
    ...
    return _spfg_rt_fn_create((spfg_rt_t *)runtime, type, phase,
...
extern spfg_err_t spfg_rt_fn_remove(spfg_runtime_t *runtime, spfg_fn_id_t fn_id)
{
    if (!runtime) {
        return SPFG_ERROR_BAD_PARAM_NULL_POINTER;
    }

    return _spfg_rt_fn_remove((spfg_rt_t *)runtime, fn_id);
}
...
extern spfg_err_t spfg_rt_dp_set_int(spfg_runtime_t *runtime, spfg_dp_id_t dp_id, spfg_int_t value)
{
    if (!runtime) {
        return SPFG_ERROR_BAD_PARAM_NULL_POINTER;
    }
...
extern spfg_err_t spfg_rt_dp_set_real(spfg_runtime_t *runtime, spfg_dp_id_t dp_id, spfg_real_t value)
{
    if (!runtime) {
        return SPFG_ERROR_BAD_PARAM_NULL_POINTER;
    }
...
extern spfg_err_t spfg_rt_dp_set_bool(spfg_runtime_t *runtime, spfg_dp_id_t dp_id, spfg_boolean_t value)
{
    if (!runtime) {
        return SPFG_ERROR_BAD_PARAM_NULL_POINTER;
    }

    return _spfg_rt_dp_set_bool((spfg_rt_t *)runtime, dp_id, value);
}


extern spfg_err_t spfg_rt_dp_get_bool(spfg_runtime_t *runtime, spfg_dp_id_t dp_id, spfg_boolean_t *value, spfg_boolean_t *emitted)
{
    if (!runtime) {
        return SPFG_ERROR_BAD_PARAM_NULL_POINTER;
    }
    ...
    return _spfg_rt_dp_get_bool((spfg_rt_t *)runtime, dp_id, value, emitted);
}


extern spfg_err_t spfg_rt_dp_set_word(spfg_runtime_t *runtime, spfg_dp_id_t dp_id, spfg_word_t word)
{
    if (!runtime) {
        return SPFG_ERROR_BAD_PARAM_NULL_POINTER;
    }
