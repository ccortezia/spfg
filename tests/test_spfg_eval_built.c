...
TEST(eval_built, test_spfg_rt_run_cycle_loose_should_eval)
{
    spfg_fn_id_t fn0;
    spfg_dp_id_t dp0;
    spfg_dp_id_t dp1;
    ...
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_fn_create(&runtime, SPFG_FN_AND_BOOL_BOOL_RET_BOOL, 0, in_dps, 2, out_dps, 1, "fn1", &fn0));
    ...
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_dp_get_bool(&runtime, dp2, &output, &emitted));
    ...
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_dp_set_bool(&runtime, dp1, false));
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_rt_run_cycle(&runtime, 0, NULL, NULL));
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_dp_get_bool(&runtime, dp2, &output, &emitted));
    TEST_ASSERT_EQUAL(false, output);
    TEST_ASSERT_EQUAL(false, emitted);
    ...
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_rt_reset_cycle(&runtime));
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_dp_set_bool(&runtime, dp0, true));
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_dp_set_bool(&runtime, dp1, true));
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_rt_run_cycle(&runtime, 0, NULL, NULL));
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_dp_get_bool(&runtime, dp2, &output, &emitted));
...
TEST(eval_built, test_spfg_rt_run_cycle_control_should_eval)
{
    spfg_fn_id_t fn0;
    spfg_fn_id_t fn1;
    spfg_dp_id_t dp0;
    ...
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_fn_create(&runtime, SPFG_FN_AND_BOOL_BOOL_RET_BOOL, 0, in_dps_fn0p0, 2, out_dps_fn0p0, 1, "fn0", &fn0));
    ...
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_dp_get_bool(&runtime, dp4, &output, &emitted));
    TEST_ASSERT_EQUAL(2, loop_ctl_1.counter);
    TEST_ASSERT_EQUAL(false, output);
    TEST_ASSERT_EQUAL(false, emitted);

    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_rt_reset_cycle(&runtime));
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_dp_set_bool(&runtime, dp0, 1));
    TEST_ASSERT_EQUAL(SPFG_ERROR_NO, spfg_dp_set_bool(&runtime, dp1, 1));
...
TEST_GROUP_RUNNER(eval_built) {
    RUN_TEST_CASE(eval_built, test_spfg_rt_run_cycle_loose_should_eval);
    RUN_TEST_CASE(eval_built, test_spfg_rt_run_cycle_control_should_eval);
}
